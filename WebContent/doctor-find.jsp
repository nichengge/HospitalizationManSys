		...
		<div class="query-conditions ue-clear">
			...
			<div class="conditionst name ue-clear" >
				...
				<div class="select-wrap">
					...
					<ul class="select-list" id="depart" style="height: 100px; overflow: auto;">
					</ul>
				</div>
			</div>
	...
	<div class="showDoctor">
		<div class=".ui-dialog-panel">
			 	<form class="formDialog">
			 		<p> 编&nbsp;&nbsp; 号：<input type="text" name="idUpdate" readonly id="idUpdate"/></p>
			 		<p> 姓&nbsp;&nbsp; 名：<input type="text" name="nameUpdate" id="nameUpdate"><label style="color:red;" class="nameUpdateError"></label></p>
			 		<p> 科&nbsp;&nbsp; 室：<select id="select_keshi">
			 	 	</select></p>
			 		<p> 性&nbsp;&nbsp; 别：<select id="select_gender">
			 		<option value="1">男</option>
			 		<option value="2">女</option>
			 	 	</select></p>
			 	 	<p> 职&nbsp;&nbsp; 称：<select id="select_zhicheng">
			 	 	</select></p>
			 		<div class="buttons">
			 			<br>
